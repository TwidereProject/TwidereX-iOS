...
extension Twitter.API.V2.FollowLookup {
    ...
    public static func following(session: URLSession, authorization: Twitter.API.OAuth.Authorization, query: Twitter.API.V2.FollowLookup.Query) -> AnyPublisher<Twitter.Response.Content<Twitter.API.V2.FollowLookup.Content>, Error> {
