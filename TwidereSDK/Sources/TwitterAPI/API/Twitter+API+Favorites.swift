...
extension Twitter.API.Favorites {
    ...
    public static func list(session: URLSession, authorization: Twitter.API.OAuth.Authorization, query: Twitter.API.Timeline.Query) -> AnyPublisher<Twitter.Response.Content<[Twitter.Entity.Tweet]>, Error> {
