...
extension UITableView {
    ...
    public static let groupedTableViewPaddingHeaderViewHeight: CGFloat = 16
    public static var groupedTableViewPaddingHeaderView: UIView {
...
extension UITableView {
    ...
    public func blinkRow(at indexPath: IndexPath) {
