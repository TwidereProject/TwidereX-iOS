...
final class StatusHistoryViewController: UIViewController, NeedsDependency, MediaPreviewableViewController {
    ...
    let logger = Logger(subsystem: "StatusHistoryViewController", category: "ViewController")
    
    weak var context: AppContext! { willSet { precondition(!isViewLoaded) } }
    weak var coordinator: SceneCoordinator! { willSet { precondition(!isViewLoaded) } }
    
    var disposeBag = Set<AnyCancellable>()
    var viewModel: StatusHistoryViewModel!
...
extension StatusHistoryViewController {
...
extension StatusHistoryViewController: UITableViewDelegate, AutoGenerateTableViewDelegate {
    // sourcery:inline:StatusHistoryViewController.AutoGenerateTableViewDelegate
