...
extension APIService {
    ...
    func twitterUserTimeline(count: Int = 200, userID: String, maxID: String? = nil, authorization: Twitter.API.OAuth.Authorization) -> AnyPublisher<Twitter.Response<[Twitter.Entity.Tweet]>, Error> {
